  ...
  return (
    <div className='content'>
      ...
      <p className='text-parcours'>
        ...
        pilotage de projet d'ingénierie logicielle, mais aussi en gestion de la relation client
        et en management d'équipe afin de garantir un profil d'expert informatique aux
        multiples facettes.
      </p>
      <br />
